...
@WebServlet("/SuperPixelization")
public class SuperPixelization extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        System.out.println(getResponseString(s.getClusterLists()).substring(0, getResponseString(s.getClusterLists()).indexOf('$')));
